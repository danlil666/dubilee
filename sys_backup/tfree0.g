...
G53 G0 X45 Y280 F10000       ; Rapid to the approach position with tool-0. (park_x, park_y - offset)
G53 G1 Y384 F6000       ; Controlled move to the park position with tool-0. (park_x, park_y)
